  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="absolute top-1/2 left-1/2 z-10 inline-flex min-h-14 min-w-32 -translate-x-1/2 -translate-y-1/2 items-center justify-center bg-foreground/70 px-6 font-mono text-base text-background transition-colors duration-150 group-hover:bg-foreground/85 group-focus-visible:bg-foreground/85"
      >
        Play
      </motion.span>
    </motion.button>
