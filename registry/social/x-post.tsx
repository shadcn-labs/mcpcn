...
const XPostView = ({ data }: XPostProps) => {
            ...
            (views && (
              <div className="flex items-center justify-between mt-3 text-muted-foreground max-w-md">
                {replies !== undefined && (
                  <button
                    aria-label="Reply"
                    className="flex items-center gap-1.5 hover:text-blue-500 transition-colors text-xs cursor-pointer"
                  >
                ...
                {retweets !== undefined && (
                  <button
                    aria-label="Repost"
                    className="flex items-center gap-1.5 hover:text-green-500 transition-colors text-xs cursor-pointer"
                  >
                ...
                {likes !== undefined && (
                  <button
                    aria-label="Like"
                    className="flex items-center gap-1.5 hover:text-pink-500 transition-colors text-xs cursor-pointer"
                  >
